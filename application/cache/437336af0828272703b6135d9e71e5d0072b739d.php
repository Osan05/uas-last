        ...
        <form>
            <div class="mb-3">
                ...
                <select class="form-control" name="username" id="username">
                  <?php $__currentLoopData = $avail_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio3">Berita</label>
</div>
            <div class="mb-3">
            ...
            <a class="btn btn-success" href="<?php echo e(site_url('Welcome/tampil')); ?>">Tampil</a>
        </form>
      </div>
    </div>
  </main>
...
<?php /**PATH D:\osnaweb\appujianwebuas-master\application\views/form.blade.php ENDPATH**/ ?>